...
require (
	...
	github.com/infodancer/oidclient v0.0.0-00010101000000-000000000000
...
// Points at the local checkout of infodancer/oidclient's feat/resource-server
// branch so the resource-server mode can be verified against memstore before
// it is merged and tagged. Replace with a real version once it is.
